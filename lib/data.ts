...
export const WC_GROUPS: Record<string, TeamStanding[]> = {
  A: [
    { name: "México",        flag: "🇲🇽", code: "MEX", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Sudáfrica",     flag: "🇿🇦", code: "RSA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Corea del Sur", flag: "🇰🇷", code: "KOR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Chequia",       flag: "🇨🇿", code: "CZE", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  B: [
    { name: "Canadá",               flag: "🇨🇦", code: "CAN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Bosnia y Herzegovina", flag: "🇧🇦", code: "BIH", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Suiza",                flag: "🇨🇭", code: "SUI", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Qatar",                flag: "🇶🇦", code: "QAT", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  C: [
    { name: "Brasil",    flag: "🇧🇷", code: "BRA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Marruecos", flag: "🇲🇦", code: "MAR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Haití",     flag: "🇭🇹", code: "HAI", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Escocia",   flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", code: "SCO", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  D: [
    { name: "Estados Unidos", flag: "🇺🇸", code: "USA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Paraguay",       flag: "🇵🇾", code: "PAR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Australia",      flag: "🇦🇺", code: "AUS", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Turquía",        flag: "🇹🇷", code: "TUR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  E: [
    { name: "Alemania",        flag: "🇩🇪", code: "GER", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Curazao",         flag: "🇨🇼", code: "CUW", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Costa de Marfil", flag: "🇨🇮", code: "CIV", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Ecuador",         flag: "🇪🇨", code: "ECU", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  F: [
    { name: "Países Bajos", flag: "🇳🇱", code: "NED", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Japón",        flag: "🇯🇵", code: "JPN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Suecia",       flag: "🇸🇪", code: "SWE", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Túnez",        flag: "🇹🇳", code: "TUN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  G: [
    { name: "Bélgica",       flag: "🇧🇪", code: "BEL", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Egipto",        flag: "🇪🇬", code: "EGY", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Irán",          flag: "🇮🇷", code: "IRN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Nueva Zelanda", flag: "🇳🇿", code: "NZL", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  H: [
    { name: "España",         flag: "🇪🇸", code: "ESP", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Cabo Verde",     flag: "🇨🇻", code: "CPV", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Arabia Saudita", flag: "🇸🇦", code: "KSA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Uruguay",        flag: "🇺🇾", code: "URU", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  I: [
    { name: "Francia",  flag: "🇫🇷", code: "FRA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Senegal",  flag: "🇸🇳", code: "SEN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Irak",     flag: "🇮🇶", code: "IRQ", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Noruega",  flag: "🇳🇴", code: "NOR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  J: [
    { name: "Argentina", flag: "🇦🇷", code: "ARG", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Argelia",   flag: "🇩🇿", code: "ALG", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Austria",   flag: "🇦🇹", code: "AUT", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Jordania",  flag: "🇯🇴", code: "JOR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  K: [
    { name: "Portugal",   flag: "🇵🇹", code: "POR", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Congo DR",   flag: "🇨🇩", code: "COD", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Uzbekistán", flag: "🇺🇿", code: "UZB", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Colombia",   flag: "🇨🇴", code: "COL", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
  L: [
    { name: "Inglaterra", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", code: "ENG", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Croacia",    flag: "🇭🇷",    code: "CRO", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Ghana",      flag: "🇬🇭",    code: "GHA", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
    { name: "Panamá",     flag: "🇵🇦",    code: "PAN", pj: 0, g: 0, e: 0, p: 0, gf: 0, gc: 0, dg: 0, pts: 0 },
  ],
};

export const CHAMPIONS: Champion[] = [
  { year: 2022, host: "Qatar",         winner: { name: "Argentina",     flag: "🇦🇷", conf: "CONMEBOL" }, runnerUp: "Francia",        score: "3-3 (4-2 pen.)" },
  { year: 2018, host: "Rusia",         winner: { name: "Francia",       flag: "🇫🇷", conf: "UEFA"     }, runnerUp: "Croacia",        score: "4-2" },
  { year: 2014, host: "Brasil",        winner: { name: "Alemania",      flag: "🇩🇪", conf: "UEFA"     }, runnerUp: "Argentina",      score: "1-0 t.e." },
  { year: 2010, host: "Sudáfrica",     winner: { name: "España",        flag: "🇪🇸", conf: "UEFA"     }, runnerUp: "Países Bajos",   score: "1-0 t.e." },
  { year: 2006, host: "Alemania",      winner: { name: "Italia",        flag: "🇮🇹", conf: "UEFA"     }, runnerUp: "Francia",        score: "1-1 (5-3 pen.)" },
  { year: 2002, host: "Corea/Japón",   winner: { name: "Brasil",        flag: "🇧🇷", conf: "CONMEBOL" }, runnerUp: "Alemania",       score: "2-0" },
  { year: 1998, host: "Francia",       winner: { name: "Francia",       flag: "🇫🇷", conf: "UEFA"     }, runnerUp: "Brasil",         score: "3-0" },
  { year: 1994, host: "EE. UU.",       winner: { name: "Brasil",        flag: "🇧🇷", conf: "CONMEBOL" }, runnerUp: "Italia",         score: "0-0 (3-2 pen.)" },
  { year: 1990, host: "Italia",        winner: { name: "Alemania Occ.", flag: "🇩🇪", conf: "UEFA"     }, runnerUp: "Argentina",      score: "1-0" },
  { year: 1986, host: "México",        winner: { name: "Argentina",     flag: "🇦🇷", conf: "CONMEBOL" }, runnerUp: "Alemania Occ.",  score: "3-2" },
  { year: 1982, host: "España",        winner: { name: "Italia",        flag: "🇮🇹", conf: "UEFA"     }, runnerUp: "Alemania Occ.",  score: "3-1" },
  { year: 1978, host: "Argentina",     winner: { name: "Argentina",     flag: "🇦🇷", conf: "CONMEBOL" }, runnerUp: "Países Bajos",   score: "3-1 t.e." },
  { year: 1974, host: "Ale. Occ.",     winner: { name: "Alemania Occ.", flag: "🇩🇪", conf: "UEFA"     }, runnerUp: "Países Bajos",   score: "2-1" },
  { year: 1970, host: "México",        winner: { name: "Brasil",        flag: "🇧🇷", conf: "CONMEBOL" }, runnerUp: "Italia",         score: "4-1" },
  { year: 1966, host: "Inglaterra",    winner: { name: "Inglaterra",    flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", conf: "UEFA"     }, runnerUp: "Alemania Occ.",  score: "4-2 t.e." },
  { year: 1962, host: "Chile",         winner: { name: "Brasil",        flag: "🇧🇷", conf: "CONMEBOL" }, runnerUp: "Checoslovaquia", score: "3-1" },
  { year: 1958, host: "Suecia",        winner: { name: "Brasil",        flag: "🇧🇷", conf: "CONMEBOL" }, runnerUp: "Suecia",         score: "5-2" },
  { year: 1954, host: "Suiza",         winner: { name: "Alemania Occ.", flag: "🇩🇪", conf: "UEFA"     }, runnerUp: "Hungría",        score: "3-2" },
  { year: 1950, host: "Brasil",        winner: { name: "Uruguay",       flag: "🇺🇾", conf: "CONMEBOL" }, runnerUp: "Brasil",         score: "2-1 †" },
  { year: 1938, host: "Francia",       winner: { name: "Italia",        flag: "🇮🇹", conf: "UEFA"     }, runnerUp: "Hungría",        score: "4-2" },
  { year: 1934, host: "Italia",        winner: { name: "Italia",        flag: "🇮🇹", conf: "UEFA"     }, runnerUp: "Checoslovaquia", score: "2-1 t.e." },
  { year: 1930, host: "Uruguay",       winner: { name: "Uruguay",       flag: "🇺🇾", conf: "CONMEBOL" }, runnerUp: "Argentina",      score: "4-2" },
];
